...
// As this is a function, it does not maintains the 'state' and only works with 'props'
...
//Updates state in parent component - As this is the class, it can maintain both 'state' & 'props'
